...
import Link from 'next/link';
  ...
  export default function addEmployeeForm(args) {
    ...
    <form action={dispatch} className="space-y-3">
        <div className="space-y-12">
            <div className="border-b border-gray-900/10 dark:border-gray-100/10 pb-12">
                <h2 className="text-base font-semibold leading-7 text-gray-900 dark:text-gray-100">Add Employee</h2>
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
            <Link href="/employees" type="button" className="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-100">
                Cancel
            </Link>
            <SubmitButton />
        </div>
